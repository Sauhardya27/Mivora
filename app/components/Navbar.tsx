        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul className={`dropdown-content z-[100] shadow-2xl bg-white/95 dark:bg-neutral-800/95 backdrop-blur-md rounded-2xl w-72 mt-4 py-3 border border-gray-200/20 dark:border-neutral-700/20 transition-all duration-300 ${
                  ...
                  <>
                    ...
                    <li>
                      <button
                        ...
                        className="flex items-center space-x-3 px-4 py-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl mx-2 w-full transition-all duration-300 group"
                      >
