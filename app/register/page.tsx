            ...
            <div className="relative z-10 w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    disabled={isGoogleLoading}
                                    className={`w-full pl-10 pr-12 py-3 bg-white/50 dark:bg-neutral-700/50 border rounded-xl focus:ring-2 focus:border-transparent backdrop-blur-sm transition-all duration-200 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 disabled:opacity-50 ${confirmPassword && password !== confirmPassword
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <label htmlFor="terms" className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                I agree to the{' '}
                                <button type="button" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium underline" disabled={isGoogleLoading}>
                                    Terms of Service
                                </button>
                                {' '}and{' '}
                                <button type="button" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium underline" disabled={isGoogleLoading}>
                ...
                <div className="text-center mt-8">
                    <div className="flex items-center justify-center space-x-2 text-sm text-emerald-700 dark:text-emerald-400">
                        ...
                        <span className="font-medium">✨ Join thousands of creators worldwide</span>
                    </div>
                </div>
            </div>
        </div>
